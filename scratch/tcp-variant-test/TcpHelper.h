...
public:
  ...
  /**
   * Create a TcpServerApplication on the specified Node.
   *
  ...
  /**
   * Create a TcpServerApplication on specified node
   *
...
public:
  ...
  /**
   * Given a pointer to a TcpClient application, set the data fill of the TCP
  ...
  /**
   * Given a pointer to a TcpClient application, set the data fill of the
   * packet (what is sent as data to the server) to the contents of the fill
   * byte.
   *
  ...
  Ptr<TcpClient> GetClient (void);
private:
  Ptr<Application> InstallPriv (Ptr<Node> node);
  ObjectFactory m_factory;
  Ptr<TcpClient> m_client;
};
